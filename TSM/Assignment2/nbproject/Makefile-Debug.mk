...
${OBJECTDIR}/Candidate.o: Candidate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/c++ `pkg-config --cflags cppunit`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Candidate.o Candidate.cpp

${OBJECTDIR}/ExaminableTopic.o: ExaminableTopic.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${OBJECTDIR}/Question.o: Question.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/c++ `pkg-config --cflags cppunit`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Question.o Question.cpp

${OBJECTDIR}/Test.o: Test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/c++ `pkg-config --cflags cppunit`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test.o Test.cpp

${OBJECTDIR}/User.o: User.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/c++ `pkg-config --cflags cppunit`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/User.o User.cpp
